...
public class CylinderMush extends Object{
    Vector3f center, radius;
    float height;
    float lineWidth;
    float putaran;

    public CylinderMush(List<ShaderModuleData> shaderModuleDataList, List<Vector3f> vertices, Vector4f color, Vector3f center, Vector3f radius, float height, float lineWidth, float putaran) {
