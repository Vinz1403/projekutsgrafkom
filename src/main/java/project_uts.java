...
//      mata kiri
            objectsMush.get(0).getChildObject().add(new Sphere(
                    Arrays.asList(
                            new ShaderProgram.ShaderModuleData("resources/shaders/scene.vert", GL_VERTEX_SHADER),
                            new ShaderProgram.ShaderModuleData("resources/shaders/scene.frag", GL_FRAGMENT_SHADER)
                    ), new ArrayList<>(
...
//                rad
            ...
            Vector3f mataKiriMush = new Vector3f(objectsMush.get(0).getChildObject().get(0).model.transformPosition(new Vector3f(0.0f, 0.0f, 0.0f)));
            objectsMush.get(0).getChildObject().get(0).translateObject(-mataKiriMush.x, -mataKiriMush.y, -mataKiriMush.z);
...
//                rad
            ...
            Vector3f mataKananMush = new Vector3f(objectsMush.get(0).getChildObject().get(1).model.transformPosition(new Vector3f(0.0f, 0.0f, 0.0f)));
            objectsMush.get(0).getChildObject().get(1).translateObject(-mataKananMush.x, -mataKananMush.y, -mataKananMush.z);
...
//baut
            objectsBox.get(0).getChildObject().add(new CylinderMush(
                    Arrays.asList(
                            new ShaderProgram.ShaderModuleData("resources/shaders/scene.vert", GL_VERTEX_SHADER),
                            new ShaderProgram.ShaderModuleData("resources/shaders/scene.frag", GL_FRAGMENT_SHADER)
                    ), new ArrayList<>(
